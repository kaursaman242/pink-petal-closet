...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-pink-500 via-pink-400 to-pink-600 text-white px-10 py-4 mt-0 font-heading ">
      <div className=" grid grid-cols-1 md:grid-cols-5 gap-6 ">


        {/* Social + Newsletter */}
       <div>
      <h2 className="text-xl font-semibold mb-4">Subscribe to our emails</h2>
      ...
      <input
        ...
        className="w-full px-4 py-2 rounded-full bg-white/80 text-black focus:outline-none"
      />

      <button className="mt-4 w-full bg-white text-pink-600 font-semibold py-2 rounded-full hover:bg-pink-100 transition">
        Subscribe
      </button>
    </div>
        ...
        {/* Quick Links */}
        <div>
          <h3 className="font-semibold text-xl mb-3 whitespace-nowrap text-center">Quick Links</h3>
        ...
        {/* Our Collection */}
        <div>
          <h3 className="font-semibold text-xl mb-3 whitespace-nowrap text-center">Our Collection</h3>
        ...
        {/* Customer Support */}
        <div>
          <h3 className="font-semibold text-xl mb-3 text-center">Support</h3>
        ...
        {/* icons */}
        <div>
          <h3 className="font-semibold text-xl mb-3 text-center">Stay Connected</h3>
          <div className="items-start pl-2 text-left ml-4 mr-4">
            <ul className="space-y-3 text-sm items-center flex flex-col">
      ...
      {/* Bottom */}
      <div className="text-center text-sm text-white mt-4 border-t pt-2">
