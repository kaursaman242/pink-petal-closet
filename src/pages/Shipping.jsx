...
import {Clock4, Van, BadgeIndianRupee, MapPinSearch} from "lucide-react"
    ...
    <div className="max-w-4xl mx-auto p-8 font-heading">
      ...
      <div className="space-y-6 text-gray-700 leading-7">
        ...
        <div className="p-5 shadow rounded-xl">
          <h3 className=" flex gap-4 font-semibold text-lg"><Clock4 /> Processing Time</h3>
          <p>Orders are processed within 1–3 working days.</p>
        </div>

        <div className="p-5 shadow rounded-xl">
          <h3 className=" flex gap-4 font-semibold text-lg"><Van /> Delivery Time</h3>
          <p>Delivery usually takes 5–7 business days across India.</p>
        </div>

        <div className="p-5 shadow rounded-xl">
          <h3 className=" flex gap-4 font-semibold text-lg"><BadgeIndianRupee /> Shipping Charges</h3>
          <p>Shipping charges may vary based on location and order value.</p>
        </div>

        <div className="p-5 shadow rounded-xl">
          <h3 className=" flex gap-4 font-semibold text-lg"><MapPinSearch /> Tracking</h3>
