...
const filteredProducts = products.filter((item) => {
  ...
  <div className="bg-pink-50 min-h-screen font-heading">
    ...
    {/* TITLE */}
    <div className="px-8 pt-8  justify-center content-center">
    ...
    <div className="flex gap-6 px-8 mt-6">
      ...
      <div className="w-1/6 space-y-4">
        ...
        <div className="bg-white p-4 rounded-2xl shadow-sm">
          <h4 className="text-pink-500 font-semibold">🎁 Special Offers</h4>
          <p className="text-sm text-gray-500 mt-1">
            Grab exciting deals on trending styles!
          </p>
          <button className="mt-3 text-sm text-pink-500 font-medium">
            Shop Now →
          </button>
        </div>
        ...
        {/* NEW ARRIVALS */}
        <div className="bg-white p-4 rounded-2xl shadow-sm">
          <h4 className="text-pink-500 font-semibold">🌸 New Arrivals</h4>
          <p className="text-sm text-gray-500 mt-1">
